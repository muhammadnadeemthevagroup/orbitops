    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="testimonials" className="py-20 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-gray-900 mb-4">
              Trusted by Mission Leaders
            </h3>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              See what space pioneers are saying about OrbitOps
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-700 mb-6 italic">
                &ldquo;OrbitOps transformed our mission control capabilities. The real-time tracking and predictive analytics saved us millions in operational costs.&rdquo;
              </p>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-600">CTO, AstroVentures</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-700 mb-6 italic">
                &ldquo;The level of precision and reliability is unmatched. OrbitOps has become an essential part of our satellite constellation management.&rdquo;
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
                  MP
                ...
                <div className="ml-4">
                  <p className="font-semibold text-gray-900">Marcus Patel</p>
                  <p className="text-sm text-gray-600">Director of Operations, Orbital Dynamics Inc.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition">
              ...
              <p className="text-gray-700 mb-6 italic">
                &ldquo;Game-changer for our mission planning. The AI-powered insights helped us optimize trajectories and reduce fuel consumption by 15%.&rdquo;
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
                  EK
                ...
                <div className="ml-4">
                  <p className="font-semibold text-gray-900">Elena Kowalski</p>
                  <p className="text-sm text-gray-600">Lead Engineer, Stellar Solutions</p>
                </div>
              </div>
            </div>
          </div>
